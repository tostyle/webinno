<div>
	...
	<div class="award-detail award-text">
		<h4 class="text-left text-bold">49 = thailand enerygy + Asean energy awards</h4>
		<h5 class="text-left">Content ที่เกี่ยวกับรางวัลที่ได้รับมา / อธิบายคร่าวๆกับรางวัลที่ได้มาโดยรวม</h5>
		<div class="award-pic">
